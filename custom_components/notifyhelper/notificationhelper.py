            ...
            if old_dict:
                ...
                if isinstance(notifications, deque):
                    ...
                    self._notifications_dict[self.entry_id
                                             ] = [deque(notifications, maxlen=100), badge]
            else:
                self._notifications_dict[self.entry_id] = [deque(maxlen=100), 0]
    ...
    async def save_notification(self, data, badge, image, video):
        ...
        try:
            ...
            async with self._lock:
                ...
                self._notifications_dict[self.entry_id] = [notifications_dq, badge]
    ...
    async def read_notification(self):
        ...
        try:
            ...
            if notifications_dq:
                ...
                async with self._lock:
                    self._notifications_dict[self.entry_id] = [notifications_dq, 0]
                    await self.save_notifications_dict()
            else:
